            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="white-box">
                    <div class="col-in row">
                        <div class="col-xs-12">
                            <h3 class="counter text-right m-t-15 text-danger">${users.getTaskPercentageByUserAndStatusId(user.getId(), status.getId())}%</h3>
                        </div>
                        <div class="col-xs-12">
	...
	<!-- END THỐNG KÊ -->
                ...
                <div class="row">
                    <c:forEach items="${statuses.getAllStatus()}" var = "status">
                        <div class="col-md-4">
                            <div class="white-box">
                                <h3 class="box-title">${status.getName()}</h3>
                                <div class="message-center">
                                    <c:forEach items="${tasks.getAllTasks(user.getId(), status.getId())}" var="task">
                                        <a href="#">
