        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form class="form-horizontal form-material" action="/EmployeeWorkManagement/edit-role" method="post">
                            <div class="form-group">
                                <label class="col-md-12">Mã quyền</label>
                                <div class="col-md-12">
                                    <input name="roleId" value="${roleId}" type="text" readonly
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input name="name" value="${role.getName()}" type="text" placeholder="Tên quyền"
                                           class="form-control form-control-line" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input name="description" value="${role.getDescription()}" type="text" placeholder="Mô tả" class="form-control form-control-line" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
