        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <form class="form-horizontal form-material" action="http://localhost:8081/EmployeeWorkManagement/task-update-2" method="post" onsubmit="return validateForm();">
                            <div class="form-group">
                                <label class="col-md-12">Mã công việc</label>
                                <div class="col-md-12">
                                    <input name="id" type="text" readonly value="${task.getId()}" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Tên công việc</label>
                                <div class="col-md-12">
                                    <input name="taskName" type="text" value="${task.getName()}" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select name="jobId" class="form-control form-control-line">
                                        <option selected value="${task.getJobId()}">${job.getJobNameByItsId(task.getJobId())}</option>
                                        <c:forEach items="${job.excludeJobById(job.getAllJobs(), task.getJobId())}" var="j">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select name="userId" class="form-control form-control-line">
                                        <option selected value="${task.getUserId()}">${user.getUserNameByUserId(task.getUserId())}</option>
                                        <c:forEach items="${user.excludeUserById(user.getAllUsers(), task.getUserId())}" var="u">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input name="startDate" type="text" value="${task.getStartDate()}" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select name="statusId" class="form-control form-control-line">
                                        <option selected value="${task.getStatusId()}">${statuses.getStatusNameByItsId(task.getStatusId())}</option>
                                        <c:forEach items="${statuses.getAllStatusExpectItsId(statuses.getAllStatus(), task.getStatusId())}" var="status">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <a href="http://localhost:8081/EmployeeWorkManagement/task" class="btn btn-primary">Quay lại</a>
                                </div>
                            </div>
                        </form>
                        <script>
